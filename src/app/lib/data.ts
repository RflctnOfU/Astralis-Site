...
export const tourInfo = [
  ...
  // },
  {
    name: "AN EVENING IN FRANCE",
    instruments: "FLUTE, CELLO, HARP",
    description:
      "Program of French music with works by Faure, Ibert, Gaubert, Damase, and female composers Boulanger and Renie",
    image: "/images/tour-images/eiffel.jpg",
    dates: [
      {
        id: 1,
        month: "AUGUST",
