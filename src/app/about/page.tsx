...
// todo: make responsive and update photos when received
function About() {
  return (
    <div className=" flex flex-col">
      <Image
        ...
        height={548}
      />
      <div className="grid grid-cols-2 gap-4 lg:mx-[5%] md:mx-[10%] mx-[16%] mb-8 bg-[#d5d5d5] bg-opacity-20 rounded-xl">
        ...
        <div className=" p-4">
          <h2
            className={`text-4xl text-center fade-in-right delay-1 ${ysabeau.className}`}
          >
            Angela Massey
          </h2>
        ...
        <div className="fade-in-right m-8 bg-[url('/images/members/Paul.jpeg')] bg-no-repeat bg-cover rounded-lg shadow-lg shadow-[hsl(290,25%,23%)] delay-2"></div>
        <div className="fade-in-left m-8 bg-[url('/images/members/rachel.webp')] bg-no-repeat bg-cover rounded-lg shadow-lg shadow-[hsl(290,25%,23%)] delay-2"></div>
        <div className=" p-4">
          <h2 className="text-4xl text-center fade-in-right delay-1">
            Rachel O&apos;Brien
          </h2>
        ...
        <div className="fade-in-right m-8 bg-[url('/images/members/see.webp')] bg-no-repeat bg-cover rounded-lg shadow-lg shadow-[hsl(290,25%,23%)] delay-2"></div>
        <div className="fade-in-left m-8 bg-[url('/images/members/owenphoto1.jpeg')] bg-no-repeat bg-cover bg-center rounded-lg shadow-lg shadow-[hsl(290,25%,23%)] delay-2"></div>
        <div className=" p-4">
          <h2 className="text-4xl text-center fade-in-right delay-1">
            Caroline Owen
          </h2>
        ...
        <div className="fade-in-right m-8 bg-[url('/images/members/dunbar6ed2.jpeg')] bg-no-repeat bg-center bg-cover rounded-lg shadow-lg shadow-[hsl(290,25%,23%)] delay-2"></div>
      </div>
    </div>
  );
}
